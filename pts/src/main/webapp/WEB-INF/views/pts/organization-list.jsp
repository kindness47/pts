...
<title>Insert title here</title>
    ...
    <link rel="stylesheet" type="text/css" href="${ptsStatic}/static/h-ui.admin/skin/default/skin.css" />
...
<body>
    ...
    <div class="Hui-article-box">
        ...
        <div class="c1 bg-1 pd-5 mt-30">
            <shiro:hasPermission name="0101-01">
...
<script type="text/javascript" src="${ptsStatic}/static/h-ui/js/H-ui.min.js"></script>
